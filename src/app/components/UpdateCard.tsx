...
import { checkForUpdate, getCachedStatus, installUpdate, restartApp, type UpdateStatus } from '@/lib/updater';
  ...
  return (
    <section className='rounded-[8px] border border-zinc-200 dark:border-white/[0.07] bg-white dark:bg-[#161616]'>
      <div className='flex items-center justify-between gap-3 px-4 py-3 border-b border-zinc-100 dark:border-white/[0.05]'>
        ...
        <span className='font-mono text-[11px] text-zinc-400 dark:text-zinc-600 tabular-nums'>v{version ?? '—'}</span>
      </div>
      ...
      <div className='px-4 py-3 space-y-3 text-[12px]'>
        ...
        <div className='flex items-center gap-2 pt-0.5'>
          {phase === 'ready' ? (
            <Button size='sm' onClick={() => void restartApp()} className='h-[30px] gap-1.5 text-[12px] font-semibold'>
